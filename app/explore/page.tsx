...
export default function ExplorePage() {
  ...
  return (
    <main className="bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100 min-h-screen py-12">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-8 bg-gradient-to-r from-slate-700 to-gray-800 bg-clip-text text-transparent">
              Explore Stories
            </h1>

            <Tabs defaultValue={token && feedPosts.length > 0 ? 'following' : 'latest'} className="w-full">
              <TabsList className="mb-8 bg-white/80 backdrop-blur-sm border border-slate-200 shadow-lg">
              ...
              {!token && (
                <Card>
                  <CardContent className="p-6">
                    ...
                    <Link href="/signup">
                      <Button className="w-full bg-gradient-to-r from-slate-700 to-gray-800 hover:from-slate-800 hover:to-gray-900">Get started</Button>
                    </Link>
                  </CardContent>
                </Card>
              )}
